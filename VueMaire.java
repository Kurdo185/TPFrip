...
public class VueMaire extends JPanel {
    ...
    public VueMaire(Modele modele) {
        ...
        modelTable.setColumnIdentifiers(new String[]{"Nom Article", "Taille", "Prix", "Description"});
    ...
    private void chargerCatalogue() {
        ...
        if (v != null) {
            ...
            for (Article a : arts) {
                modelTable.addRow(new Object[]{a.getNom(), a.getTaille(), a.getPrix() + " €", a.getDescription()});
            }
        }
    }
}